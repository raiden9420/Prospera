...
class SmartFinanceAssistant:
    ...
    async def analyze_query(self, query: str) -> Dict[str, Any]:
        ...
        if any(word in query_lower for word in ['trip', 'travel', 'vacation', 'holiday', 'europe', 'abroad']):
        ...
        elif any(word in query_lower for word in ['spending', 'spent', 'expenses', 'spend', 'transactions']):
            ...
            if 'june 2024' in query_lower:
                ...
                specific_focus = ["monthly", "specific_month"]
            elif 'trend' in query_lower or 'all time' in query_lower or 'all transactions' in query_lower:
                time_period = "all_time"
    ...
    async def _fetch_bank_data(self, sessionid: str, analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Use TransactionProcessor to parse the raw bank data
            ...
            if time_period == "june_2024":
                ...
                # Default to current month for demo data
                start_date = datetime(2020, 1, 1)
                end_date = datetime(2025, 12, 31)
    ...
    def build_focused_prompt(self, query: str, analysis: Dict[str, Any], context: Dict[str, Any], chat_history: List[Dict[str, str]] = None) -> str:
        ...
        prompt_lines = [
            "You are Prospera, an intelligent financial assistant. You have access to the user's financial data and chat history.",
            "CRITICAL RULES:",
            "1. ALWAYS use ₹ (Indian Rupees) - NEVER use P (Peso) or $ (Dollar)",
            "2. Be specific with numbers and percentages",
            "3. Provide actionable insights based on their actual data with proper plan to achieve it",
            "4. Keep responses concise but informative (3-4 sentences max)",
